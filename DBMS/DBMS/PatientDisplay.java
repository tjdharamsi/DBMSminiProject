...
{
 JLabel lpatname,lpid,ldateadd,lpattype,lph,lbloodgrp,ldob,larea,lcity,ldid,ldoa,lgender,lph1,lph2,lcur;
 String patname,pattype,name,dateadd,patype,bloodgroup,dob1,area,city,did,doa,gender,ph1,ph2,cur,pid1;
 JButton bok;
 int pid,did1;
 PatientDisplay(String x,int pid2,String name2,String bloodgrp,String dob,String area1,String city1,int did2,String doa1,String gndr,String ph3,String ph4,String problem)
 {
  ...
  pattype="Out Patient";
   ...
   ldob=new JLabel("Date Of Birth :    "+dob1);
    ...
    lph.setBounds(100,520,200,20);
    add(lph);    
    
    lph1=new JLabel("1.  :  "+ph1);
    lph1.setBounds(300,520,150,20);
    add(lph1);  
    
    lph2=new JLabel("2.  :  "+ph2);
    lph2.setBounds(450,520,150,20);
    add(lph2); 
    
	 
	 bok=new JButton("OK",new ImageIcon("images/ok.png"));
	 bok.setBounds(250,580,80,30);
	 add(bok);
