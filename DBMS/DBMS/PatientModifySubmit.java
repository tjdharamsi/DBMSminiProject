...
class PatientModifySubmit extends JFrame implements ActionListener
{
    ...
    PatientModifySubmit(String x,int pid2,String name2,String bloodgrp,String dob,String area1,String city1,int did2,String doa1,String gndr,String ph3,String ph4,String problem)
    {
...
//End of medical Information
	...
	bclr.addActionListener(new PatientModifySubmit.clear());
	bsub.addActionListener(new PatientModifySubmit.submit());
	bback.addActionListener(new PatientModifySubmit.back());
	bhome.addActionListener(new PatientModifySubmit.home());
        bdoclist.addActionListener(new PatientModifySubmit.doclist());
	...
	public void actionPerformed(ActionEvent ae)
	{
	  ...
	  try
	   ...
	   int i=0;
                ...
                String sql4 ="update out_patient set illness='"+cur+"' where pid="+pid1+";";
