...
class ViewPatientOptionsIn extends JFrame implements ActionListener
{
 JButton bback,bpatientList,bsearchPatient,bhome;
 JLabel lpatientList,lsearchPatient,linfo;
 String name;
 
 ViewPatientOptionsIn(String x)
 {
  ...
  lsearchPatient=new JLabel("2. Search particular Patient details");
