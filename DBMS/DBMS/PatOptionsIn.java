...
class PatOptionsIn extends JFrame implements ActionListener
{
    ...
    PatOptionsIn(String x)
	{
		...
		badd.addActionListener(new PatOptionsIn.add());
		bmod.addActionListener(new PatOptionsIn.mod());
		bview.addActionListener(new PatOptionsIn.view());
		bback.addActionListener(new PatOptionsIn.back());
                bdelete.addActionListener(new PatOptionsIn.delete());
