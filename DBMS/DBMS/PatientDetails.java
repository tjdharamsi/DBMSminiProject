...
class PatientDetails extends JFrame implements ActionListener
{
 JLabel lpid;
 ...
 PatientDetails(String x)
 {
  ...
  bclr.addActionListener(new PatientDetails.clear());
  bsub.addActionListener(new PatientDetails.submit());
  bback.addActionListener(new PatientDetails.back());
        ...
        public void actionPerformed(ActionEvent ae)
        {
         ...
         else
         {
            try
             ...
             new PatientDisplay(name,did1,name1,bloodgp,dob,area,city,did1,doa,gender,ph1,ph2,cur);
             setVisible(false);
             rs2.close();
            stmt.close();
             c.close();
