...
class ViewPatientList extends JFrame implements ActionListener
{
 JTable patList;
 JScrollPane jsp;
 JButton bok;
 ...
 ViewPatientList(String x)
 {
   super("Logged in as " +x);
    ...
    {    
      ...
      String sql="Select count(*) from Out_patient;";
      ...
      pat=new String[n][3];
      String sql1="Select pid,name,did from patient where pid in(select pid from out_patient);";
    ...
    catch (Exception e)
    {
     ...
     add(bok);
      ...
      bok.addActionListener(new ViewPatientList.ok());
