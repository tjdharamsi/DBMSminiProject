...
//End of medical Information
	...
	bclr.addActionListener(new PatientAddIn.clear());
	bsub.addActionListener(new PatientAddIn.submit());
	bback.addActionListener(new PatientAddIn.back());
	bhome.addActionListener(new PatientAddIn.home());
        bdoclist.addActionListener(new PatientAddIn.doclist());
	...
	public void actionPerformed(ActionEvent ae)
	{
	  ...
	  try
	   ...
	   int i=0;
                ...
                String sql4 ="Insert Into In_Patient values("+pid1+",'"+cur+"','"+rno+"');";
