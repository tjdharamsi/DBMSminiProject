...
class DoctorModify extends JFrame implements ActionListener
{
 ...
 JTextField tfdid;
 String did;
 String name,name1,type,qualific,special,workhr,area,city,nid,ph1="",ph2="";
  ...
  class submit implements ActionListener
  {
        public void actionPerformed(ActionEvent ae)
        {
         ...
         else
         {
             ...
             new DoctorModifySubmit(name,did1,name1,type,qualific,special,area,city,nid1,ph1,ph2);
             setVisible(false);
             rs2.close();
            stmt.close();
             c.close();
